    ...
    for (int q=0; q<total_inputs; q++)
    {
        ...
        else
        {
            ...
            do
            {
                ...
                /*
                 parsed[binarytodecimal(statetobinary(planea, planeb, planec))] = 1;
                 shiftplane(1, 0, planea, newplanea);
                 shiftplane(1, 0, planeb, newplaneb);
                 shiftplane(1, 0, planec, newplanec);
                 cout<<"check 1: "<<binarytodecimal(statetobinary(planea, planeb, planec))<<endl;
                 printstatebinary(planea, planeb, planec);
                 cout<<"check 2: "<<binarytodecimal(statetobinary(newplanea,newplaneb,newplanec))<<endl;
                 printstatebinary(newplanea, newplaneb, newplanec);
